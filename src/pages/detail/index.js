    ...
    <div>
      {loading ? (
        ...
        <div>
          ...
          {/* Redirectdeve fazer com que o aplicativo renderize o PetDetailsNotFoundcomponente.  este se seu código funciona clicando em 'Dottie' - o segundo animal de estimação na visualização 'Todos os animais de estimação'. Como não temos os detalhes de Dottie, a API retornará um erro e você deverá ser redirecionado para a PetDetailsNotFoundpágina*/}
